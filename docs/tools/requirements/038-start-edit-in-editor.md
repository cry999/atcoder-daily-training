...
| `docs/tools/usage/start.md` / `docs/tools/usage/test.md` / `docs/tools/usage/config.md` | キー表に `Ctrl+E`、config に `editor` キーを追記 |
...
- 利用手引: `docs/tools/usage/start.md` / `docs/tools/usage/test.md` / `docs/tools/usage/config.md`
