...
|---|---|
| `cmd/exercise/` | `cmd/atcoder/` |
| `docs/tools/exercise-test-usage.md` | `docs/tools/usage/test.md` |
...
| `docs/tools/exercise-commit-usage.md` | `docs/tools/usage/commit.md` |
| `docs/tools/exercise-stats-usage.md` | `docs/tools/usage/stats.md` |
