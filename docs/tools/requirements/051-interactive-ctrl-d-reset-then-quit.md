...
| `docs/tools/atcoder-test-usage.md` | 対話モードの `Ctrl+D` 説明を「1 回でリセット・2 回連続で終了」に更新 |
| `docs/tools/atcoder-start-usage.md` | 分割画面キー表の `Ctrl+D` 行を同様に更新 |
...
- `docs/tools/atcoder-test-usage.md` / `atcoder-start-usage.md` (キー説明の更新先)
