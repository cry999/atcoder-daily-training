...
| [0010](0010-mode-rename-contest-exercise.md) | 配置規約を `layout {auto,abc,exercise}` から `mode {contest,exercise}` に再設計する | Accepted | 設計のみ ([070](../requirements/070-contest-exercise-mode.md)) |
