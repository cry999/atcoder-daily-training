...
> 要件詳細は [`requirements/031-nav-direct-target.md`](requirements/031-nav-direct-target.md)。ナビ [027](requirements/027-start-problem-navigation.md) を相対移動に加え絶対ジャンプへ拡張。
