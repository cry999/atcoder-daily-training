...
> 要件詳細は [`requirements/030-command-mode-completion.md`](requirements/030-command-mode-completion.md)、利用手引は [`atcoder-test-usage.md`](atcoder-test-usage.md) / [`atcoder-start-usage.md`](atcoder-start-usage.md) のコマンドモード節。
