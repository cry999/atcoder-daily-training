...
> 要件詳細は [`docs/tools/requirements/050-atcoder-self-update.md`](requirements/050-atcoder-self-update.md)、利用手引は [`atcoder-update-usage.md`](atcoder-update-usage.md)。
...
## AQ. chat command モードからの meta 編集 (`:meta` url / time_limit) ✅ DONE (123f0cd)

> 要件詳細は [`requirements/050-chat-meta-edit.md`](requirements/050-chat-meta-edit.md)。利用手引は [`atcoder-meta-usage.md`](atcoder-meta-usage.md) / [`atcoder-test-usage.md`](atcoder-test-usage.md) / [`atcoder-start-usage.md`](atcoder-start-usage.md) の command モードのコマンド表。CLI 側の元仕様は [AL](#al-task-url-直指定の-dl--meta-編集-atcoder-meta--done-94d8937-url-override-後続コミット) ([046](requirements/046-meta-command.md))、フック注入の前例は [U](#u-chat-内からの提出準備-ctrls--done-c5d3227) ([026](requirements/026-chat-submit.md))。
