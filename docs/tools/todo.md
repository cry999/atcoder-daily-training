...
## Z. chat `:debug` トグルを watch ペインへ反映 ✅ DONE (80e0534)

> 要件詳細は [`requirements/033-start-debug-watch-sync.md`](requirements/033-start-debug-watch-sync.md)。[030](requirements/030-chat-debug-cheat-commands.md) で入れた `:debug` を分割画面の watch ペインにも波及させる。
