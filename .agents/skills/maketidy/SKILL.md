...
| 6 | **skills / AGENTS.md** | コマンド名・ディレクトリ規約・doc パスの記述が実装と一致するか (リネーム後に特に効く) |
...
1. **worktree を切る** (AGENTS.md 必須)。ブランチ名は `docs-sync-usage`・`tidy-broken-links` など。
